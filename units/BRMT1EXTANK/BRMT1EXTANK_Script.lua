...
BRMT1EXTANK = Class(TLandUnit){
	...
	CreateTheEffects = function(self)
		...
		for _, v in TMEffectTemplate['BRMT3EXBMPOWEREFFECT'] do
			TrashBagAdd(trash, CreateAttachedEmitter(self, 'eff01', army, v):ScaleEmitter(2.10))
		end
	end,
	...
	CreateTheEffectsDeath = function(self)
		local army = self.Army
		local trash = self.Trash
		for _, v in TMEffectTemplate['BRMT1EXTANKDEATH'] do
			TrashBagAdd(trash,CreateAttachedEmitter(self, 'BRMT1EXTANK', army, v):ScaleEmitter(4.7))
		end
	end,
}
