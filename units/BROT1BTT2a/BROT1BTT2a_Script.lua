...
---@class BROT1BTT2a : AHoverLandUnit
BROT1BTT2a = Class(AHoverLandUnit){
	...
	CreateTheEffectsDeath = function(self)
		...
		for _, v in TMEffectTemplate['AeonUnitDeathRing01'] do
			TrashBagAdd(trash, CreateAttachedEmitter(self, 'BROT1BTT2a', army, v):ScaleEmitter(0.45))
		end
	end,
}
